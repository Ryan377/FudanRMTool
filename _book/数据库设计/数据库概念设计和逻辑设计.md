...
![数据库ER图](https://gitee.com/freemansonary/markdown-pic-bed/raw/master/Typora/20210604113854.png)
...
| 字段名        | 解释         | 类型        | 备注 |
| ------------- | ------------ | ----------- | ---- |
| RoleProjectID | 项目角色编号 | varchar(20) | 主键 |
...
| 角色/权限  | 为项目添加成员 | 为项目添加模块 | 为模块创建/导入文档                                        | 编辑文档                      | 查看文档 | 发布评论 |
| ------------ | -------------- | -------------- | ---------------------------------------------------------- | ----------------------------- | -------- | -------- |
| 项目创建者(1) | √              | √              | √                                                          | √                             | √        | √        |
| 项目管理员 | √ | √ | √ | √ | √ | √ |
| 高级开发成员 | × |        √        | √ | √ | √        | √        |
